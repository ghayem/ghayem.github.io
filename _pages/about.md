...
Starting March 2023, I am serving as a postdoctoral researcher at the [MIND team](https://team.inria.fr/mind/) in [Inria-Saclay](https://www.inria.fr/fr) working under the supervision of [Prof. Bertrand Thirion](https://scholar.google.fr/citations?user=MeKi5_AAAAAJ&hl=fr). My current research focuses on the intersection of machine learning, signal processing, and statistics to analyze brain meta-analysis using Large Language Models (LLMs) in the field of neuroscience and neuroimaging.
